...
constexpr ActuatorStatus kReady{ActuatorState::READY, 0};
constexpr ActuatorStatus kReloading{ActuatorState::RELOADING, 1};
...
TEST(ServoParametersTest, TargetLeftOfCentreCommandsRight)
{
...
TEST(ServoParametersTest, TargetRightOfCentreCommandsLeft)
{
